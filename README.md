...
Lưu Ý! Đây Là Sản Phẩm Được Trankhuong Remake [Tác Giả Hiện Tại Không Chịu Trách Nghiệm Nào ! ), Nếu Có Lỗi Hãy Thử Sử Dụng Sang Sản Phẩm Khác !
...
```javascript
const login = require("trankhuong"); // lấy từ lib ra 
...
```js
const fs = require("fs");
const login = require("trankhuong");
